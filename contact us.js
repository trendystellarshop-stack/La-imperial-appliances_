document.addEventListener('DOMContentLoaded', function () {
    ...
    function alertFieldError(fieldId, message) {
    ...
    contactForm.addEventListener('submit', function (event) {
        ...
        if (!email) {
            ...
            alertFieldError('email', 'Incorrect email address. Please enter a valid email.');
            return;
        }
        ...
        if (!phone) {
            ...
            alertFieldError('phone', 'Incorrect phone number. Please enter exactly 11 digits.');
            return;
        }
